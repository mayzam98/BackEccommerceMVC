...
namespace BackEccommerceMVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<ActionResult> Inicio(string nombreBuscar, string idBuscar)
        {
            ...
            else if (nombreBuscar == "" && idBuscar != "")
            {
                if (idBuscar != "")
                {
                    foreach (var item in products)
                    {
                        if (item.productId.Contains(idBuscar))
                        {
                            //comentario
                            listaFiltrada.Add(item);
                        }
